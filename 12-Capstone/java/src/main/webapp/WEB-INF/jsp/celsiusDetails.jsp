		...
		<div class="row">
			<c:forEach items="${weatherList}" var="weatherlist">
				<div class="col-auto">
					...
					<div class="tepm-high-low">High: ${(weatherlist.high - 32) * (5 / 9)} C <br>
						Low: ${(weatherlist.low - 32) * (5 / 9)} C</div>
				</div>
			</c:forEach>
		</div>
	</div>
	<a href="<c:url value="/parkDetails?parkCode=${parkslist.parkCode}"/>">
		<input class="farhenheit-button" type="button" value="Farhenheit Conversion" />
	</a>
</section>
